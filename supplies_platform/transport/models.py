...
class TransportDetail(TimeStampedModel):
    ...
    proposed_loading_time = models.TimeField(default=now)
    loading_time_start = models.TimeField(default=now)
    loading_time_end = models.TimeField(default=now)
    unloading_time_start = models.TimeField(default=now)
    unloading_time_end = models.TimeField(default=now)
